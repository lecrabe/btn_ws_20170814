...
segdir  <- paste0(rootdir,"segments_FREL/Scale0.2_Shape0_Compact1/")

start_time <- Sys.time()
####### Read shapefile of segmentation from eCognition
shapename <- paste0(segdir,"ScalePara.2_shape0_compact1.shp")
...
system(sprintf("gdal_translate -ot Byte -co COMPRESS=LZW %s %s",
               paste0(gfcdir,"tmp_pct_byte_reclass_segments.tif"),
               paste0(gfcdir,"DD_2004_2009_druk_para02_20171004.tif")
))
...
system(sprintf("gdal_translate -ot Byte -co COMPRESS=LZW %s %s",
               paste0(gfcdir,"tmp_pct_byte_reclass_segments.tif"),
               paste0(gfcdir,"DD_2009_2014_druk_para02_20171004.tif")
))
...
system(sprintf("oft-stat -i %s -o %s -um %s -nostd",
               paste0(gfcdir,"DD_2009_2014_druk_para02_20171004.tif"),
               paste0(gfcdir,"stat_2009_2014_DD_druk_para02_20171004.txt"),
               paste0(gfcdir,"DD_2009_2014_druk_para02_20171004.tif")
))

(stats_pixel <- read.table(paste0(gfcdir,"stat_2009_2014_DD_druk_para02_20171004.txt")))
